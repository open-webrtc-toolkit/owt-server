{
  'targets': [{
    ...
    'sources': [
      ...
      'BufferManager.cpp',
      'HardwareVideoFrameMixer.cpp',
      'VideoLayoutProcessor.cpp',
      'VideoMixer.cpp',
      'hardware/VideoMixEngine.cpp',
      'hardware/VideoMixEngineImp.cpp',
    ...
    'include_dirs': [ '$(CORE_HOME)/common',
                      ...
                      '$(CORE_HOME)/../../third_party/mediaprocessor/libxcode/video',
                      '$(CORE_HOME)/../../third_party/mediaprocessor/libxcode',
                      '$(CORE_HOME)/../../third_party/webrtc/src' ],
    'libraries': [
      '-lboost_thread',
      '-llog4cxx',
      '-L$(CORE_HOME)/../../third_party/webrtc', '-lwebrtc',
      '-L$(CORE_HOME)/../../third_party/mediaprocessor/dist', '-lxcodebase', '-lxcodevideo', '-lvpx',
    ],
    'conditions': [
      [ 'OS=="mac"', {
        'xcode_settings': {
