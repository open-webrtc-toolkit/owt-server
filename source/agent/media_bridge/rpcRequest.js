...
var RpcRequest = function(rpcChannel) {
  ...
  that.handleCascadingEvents = function(controller, event) {
    return rpcChannel.makeRPC(controller, 'handleCascadingEvents', [event], 4000);
  };

  that.onCascadingConnected = function(controller, bridgeId, sessionId, streamId, clientId) {
    return rpcChannel.makeRPC(controller, 'onCascadingConnected', [bridgeId, sessionId, streamId, clientId], 4000);
  };
