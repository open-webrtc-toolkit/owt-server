...
exports.AccessNode = function () {
    ...
    that.unpublish = function (stream_id, subscriptions_reserved) {
        ...
        if (streams[stream_id]) {
            for (var subscription_id in subscriptions) {
                ...
                if (!subscriptions_reserved && subscriptions[subscription_id].audio === undefined && subscriptions[subscription_id].video === undefined) {
    ...
    that.unsubscribe = function (subscription_id, reserved) {
