{
  'targets': [{
    ...
    'sources': [
      ...
      'woogeen_base_old/AudioFrameConstructor.cpp',
      'woogeen_base_old/AudioFramePacketizer.cpp',
      '../../../core/woogeen_base/AudioUtilities.cpp',
      '../../../core/woogeen_base/MediaFramePipeline.cpp',
      'woogeen_base_old/VideoFrameConstructor.cpp',
      '../../../core/erizo/src/erizo/rtp/RtpSource.cpp',
      '../../../core/erizo/src/erizo/rtp/RtpSink.cpp',
      'woogeen_base_old/VideoFramePacketizer.cpp',
