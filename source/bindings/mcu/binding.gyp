{
  'targets': [
  {
    'target_name': 'addon',
      ...
      'include_dirs' : ['$(CORE_HOME)/common', '$(CORE_HOME)/erizo/src/erizo', '$(CORE_HOME)/woogeen_base', '$(CORE_HOME)/mcu', '$(CORE_HOME)/../../build/libdeps/build/include', '$(CORE_HOME)/../../third_party/libuv-0.10.26/include', '$(CORE_HOME)/../../third_party/webrtc'],
