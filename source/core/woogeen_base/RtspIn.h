...
public:
    ...
    DLL_PUBLIC RtspIn (const Options&);
    DLL_PUBLIC RtspIn (const std::string& url, const std::string& transport, uint32_t bufferSize, bool enableAudio, bool enableVideo);
    virtual ~RtspIn();
