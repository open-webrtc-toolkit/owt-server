...
bool VCMInputProcessor::init(woogeen_base::WoogeenTransport<erizo::VIDEO>* transport, boost::shared_ptr<VideoFrameMixer> frameReceiver, boost::shared_ptr<TaskRunner> taskRunner)
{
