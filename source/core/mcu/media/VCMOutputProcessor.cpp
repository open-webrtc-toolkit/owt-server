...
VCMOutputProcessor::VCMOutputProcessor(int id, boost::shared_ptr<VideoFrameEncoder> source, woogeen_base::WoogeenTransport<erizo::VIDEO>* transport, boost::shared_ptr<TaskRunner> taskRunner)
    : VideoFrameSender(id)
