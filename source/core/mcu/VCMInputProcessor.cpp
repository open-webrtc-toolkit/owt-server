...
bool VCMInputProcessor::init(woogeen_base::WoogeenTransport<erizo::VIDEO>* transport, boost::shared_ptr<VideoFrameProcessor> frameReceiver, boost::shared_ptr<TaskRunner> taskRunner)
{
