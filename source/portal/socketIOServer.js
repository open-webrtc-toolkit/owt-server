...
var Client = function(participantId, socket, portal, on_disconnect) {
  ...
  that.listen = function() {
    ...
    socket.on('publish', function(options, url, callback) {
      ...
      ((stream_description.video && options.video.resolution && (typeof options.video.resolution.width === 'number') && (typeof options.video.resolution.height === 'number')) && (stream_description.video.resolution = widthHeight2Resolution(options.video.resolution.width, options.video.resolution.height))) ||
