...
const RpcRequest = function(rpcChannel) {
  const that = {};
  ...
  that.publish = function(controller, participantId, streamId, Options) {
    return rpcChannel.makeRPC(
        controller,
        'publish',
        [participantId, streamId, Options],
    );
  };
  ...
  that.subscribe =
    function(controller, participantId, subscriptionId, Options) {
      return rpcChannel.makeRPC(
          controller,
          'subscribe',
  ...
  that.subscriptionControl =
    function(controller, participantId, subscriptionId, command) {
      return rpcChannel.makeRPC(
          controller,
          'subscriptionControl',
