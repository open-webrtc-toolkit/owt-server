...
- WebRTC Open Project:
    ...
    http://www.webrtc.org
# 2 Gateway Installation for SIP  {#section2}
...
## 2.2 Requirements and test environment {#section2_2}
...
Install the OpenH264 library to support H.264 in the gateway for SIP when required, refer to the [Install the Cisco OpenH264 Library](#section2_2_1) section for more details.
...
<tr>
<td>Web browser</td>
<td><ul><li>Google Chrome* v46</li>
<li>Firefox* v41</li></ul>
</td>
</tr>
</tbody>
</table>
...
### 2.2.1 Install the Cisco OpenH264 Library {#section2_2_1}
...
## 2.3 Configure the gateway machine  {#section2_3}
...
## 2.6 Launch the gateway server {#section2_6}
...
## 2.7 Stop the gateway server {#section2_7}
...
~~~~~~~
### 3.1.2 SDK special considerations {#section3_1_2}
...
@endhtmlonly
## 3.4 Methods {#section3_4}
### 3.4.1 Client {#section3_4_1}
####connect(onFailure) {#section3_4_1_1}
...
####unpublish(Stream, onFailure) {#section3_4_1_7}
...
####subscribe(Stream, onFailure) {#section3_4_1_8}
...
####unsubscribe(Stream, onFailure) {#section3_4_1_9}
...
####send(string/Object, onSuccess, onFailure) {#section3_4_1_10}
...
####show(string, Object) {#section3_4_2_3}
...
####addEventListener(string, callback) {#section3_4_2_6}
This function registers a callback function as a handler for a corresponding event.
####on(string, callback) {#section3_4_2_7}
This function is equivalent to addEventListener.
###3.4.3 Miscellaneous {#section3_4_3}
####Logger.setLogLevel(Number) {#section3_4_3_1}
This function sets the log level. There are 6 log levels:
 ...
 - Logger.ERROR
 - Logger.NONE
##3.5 Call procedure {#section3_5}
###3.5.1 Register to a SIP server {#section3_5_1}
...
###3.5.2 Make a call {#section3_5_2}
...
~~~~
###3.5.3 Accept a call {#section3_5_3}
...
~~~~
###3.5.4 Reject a call {#section3_5_4}
