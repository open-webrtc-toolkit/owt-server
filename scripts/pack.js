...
optParser.addOption('t', 'target', 'list', 'Specify target to pack');
optParser.addOption('i', 'install-module', 'boolean', 'Whether install node module after packing');
optParser.addOption('r', 'repack', 'boolean', 'Whether clean dist before pack');
optParser.addOption('e', 'encrypt', 'boolean', 'Whether encrypt during pack');
optParser.addOption('d', 'debug', 'boolean', 'Whether pack debug version');
optParser.addOption('o', 'addon-debug', 'boolean', 'Whether pack debug addon');
optParser.addOption('f', 'full', 'boolean', 'Whether perform a full pack');
optParser.addOption('s', 'sample-path', 'string', 'Specify sample path');
optParser.addOption('a', 'archive', 'string', 'Specify archive name');
