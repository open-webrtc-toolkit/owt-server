...
#fi
./tools/gyp/gyp --depth=. -D target_arch="x64" -D os_posix=1 -D clang=0 -D build_with_chromium=0 -D include_tests=0 -D enable_protobuf=0 -D use_x11=0 -D build_libvpx=0 -D use_system_yasm=1 -D include_capture=0 -D include_render=0 -D include_internal_audio_device=0 -D chromeos=0 webrtc/webrtc.gyp
